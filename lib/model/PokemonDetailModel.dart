  ...
  PokemonDetail.fromJson(Map<String, dynamic> json) {
    if (json['abilities'] != null) {
      ...
      json['abilities'].forEach((v) {
        // abilities!.add(new Null.fromJson(v));
      });
    }
...
class GameIndices {
  ...
  GameIndices.fromJson(Map<String, dynamic> json) {
    ...
    version =
        json['version'] != null ? new Forms.fromJson(json['version']) : null;
  }
...
class Moves {
  ...
  Moves.fromJson(Map<String, dynamic> json) {
    move = json['move'] != null ? new Forms.fromJson(json['move']) : null;
...
class VersionGroupDetails {
  ...
  VersionGroupDetails.fromJson(Map<String, dynamic> json) {
    ...
    moveLearnMethod = json['move_learn_method'] != null
        ? new Forms.fromJson(json['move_learn_method'])
        : null;
    versionGroup = json['version_group'] != null
        ? new Forms.fromJson(json['version_group'])
        : null;
  }
...
class Stats {
  ...
  Stats.fromJson(Map<String, dynamic> json) {
    ...
    effort = json['effort'];
    stat = json['stat'] != null ? new Forms.fromJson(json['stat']) : null;
  }
...
class Types {
  ...
  Types.fromJson(Map<String, dynamic> json) {
    slot = json['slot'];
    type = json['type'] != null ? new Forms.fromJson(json['type']) : null;
  }
